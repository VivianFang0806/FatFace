...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/josephine/Documents/research/FatFaceIllusion/program/Exp1/FatFace_lastrun.py',
...
for thisBlockTrail in BlockTrail:
    ...
    for thisAF_Loop in AF_Loop:
        ...
        while continueRoutine:
            ...
            # *AFMouse* updates
            if AFMouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        # the Routine "AsianF" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
    ...
    for thisAM_Loop in AM_Loop:
        ...
        while continueRoutine:
            ...
            # *AMMouse* updates
            if AMMouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        # the Routine "AsianM" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
    ...
    for thisCF_Loop in CF_Loop:
        ...
        while continueRoutine:
            ...
            # *CFMouse* updates
            if CFMouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        # the Routine "CaucasianF" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
    ...
    for thisCM_Loop in CM_Loop:
        ...
        while continueRoutine:
            ...
            # *CMMouse* updates
            if CMMouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        # the Routine "CaucasianM" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
