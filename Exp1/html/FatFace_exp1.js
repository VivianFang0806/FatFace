...
function BlockTrailLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisBlockTrail of BlockTrail) {
...
function AF_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAF_Loop of AF_Loop) {
...
function AM_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAM_Loop of AM_Loop) {
...
function CF_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisCF_Loop of CF_Loop) {
...
function CM_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisCM_Loop of CM_Loop) {
...
function AsianFRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of AsianFComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AsianMRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of AsianMComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CaucasianFRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CaucasianFComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function CaucasianMRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of CaucasianMComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
